...
(function (factory) {
    ...
    $.widget('blueimp.fileupload', $.blueimp.fileupload, {
        ...
        processActions: {
            // Loads the image given via data.files and data.admin
            ...
            // inplace at data.admin of data.files:
        ...
        // Resizes the file at the given admin and stores the created blob at
